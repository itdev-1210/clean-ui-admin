export async function getLeftMenuData() {
  return [
    ...
    {
      title: 'Buy Marine Coins',
      key: 'buyMarineCoins',
      icon: 'icmn icmn-coin-dollar'
    },
    {
      title: 'Initial Asset Offering',
      key: 'initialAssetOffering',
    ...
    {
      title: 'Dashboard Alpha Custom',
      key: 'dashboardAlphaCustom',
      url: '/dashboard/alphacustom',
      icon: 'icmn icmn-home',
    },
    {
